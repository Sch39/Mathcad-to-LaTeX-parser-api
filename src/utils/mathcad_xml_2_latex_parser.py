...
# Other files
from .mathcad_symbol_parser import symbol_parser  # Import function which formats special charecters

class MathcadXML2LatexParser(object):
    ...
    def __init__(self, filename):
        ...
        self.is_corrupt = False  # As a starting point, the file is ok
        ...
        try:  # Try to parse the file into a ElementTree
            ...
            self.is_corrupt = True  # Make sure rest of file is not tried parsed
        ...
        self.output_file_path = self.output_folder + "/" + self.filename + '.tex'
        self.tex_file = io.open(self.output_file_path, 'w', encoding="utf-8")
    ...
    def parse(self):
        ...
        """
        if self.is_corrupt:
            print("Can't parse, File is corrupted!")
            return
